...
class Maze
{
    ...
    public static void main(String[] args)
    {
        int[][] grid = {
                ...
                { WALL,  EMPTY,  WALL,  WALL, EMPTY,  EMPTY, EMPTY,  WALL, EMPTY, WALL},
        ...
        if(!solved)
        {
            System.out.println("You have failed to escape from the maze. Future archeologists gaze upon your remains in bafflement."); // Did not reach the end.
        }
